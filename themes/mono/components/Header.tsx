...
// TODO Phase 2: Replace with a custom implementation — borderless, monospace
// throughout, solid-only background, amber accent on active links.
...
export default async function Header() {
  ...
  return (
    <HeaderClient
      ...
      headerBackground={designConfig.headerBackground ?? "solid"}
